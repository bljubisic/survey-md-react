...
import * as SurveyNode from "./SurveyNode.stories.tsx";

<Meta of={SurveyNode} title="SurveyNode" />

# SurveyNode

SurveyNode component with different props.

#### Example

<Canvas of={SurveyNode.Primary} />
